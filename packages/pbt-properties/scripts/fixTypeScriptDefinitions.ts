...
const fixTypeScriptDefinition = (moduleFormat: string): void => {
  ...
  const searchString =
    'export declare const property: <TGens extends Gens>(...args_0: TGens, args_1: PropertyFunction<TGens>) => Property<GenValues<TGens>>;';
  const replaceString =
    'export declare const property: <TGens extends Gens>(...args: [...TGens, PropertyFunction<TGens>]) => Property<GenValues<TGens>>;';
